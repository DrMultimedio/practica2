...
function foormatear_entradas(a)
{
	...
	for (var i = a.FILAS.length - 1; i >= 0; i--) 
	{
		...
		articulo.innerHTML="<header><h4>"+titulo+"</h4></header><div class = 'hoveroculto'><img src='fotos/"+idp+"/"+foto+"' alt='"+des+"'/><span><p>"+descripcion+"</p><a href='viaje.html?id="+idp+"'><b>Seguir Leyendo</b>&nbsp;-></a></span></div><br/><div class='valoracion'><aside class='estrellas'><span class='icon-star'></span><span class='icon-star'></span><span class='icon-sta'></span><span class='icon-star'></span><span class='icon-star'></span></aside></div><br/><footer><h6>Autor:"+usu+", Fecha de edicion:<time datetime='2016'>"+feinicio+"</time></h6></footer>";
